import run, {recreateDir,copy,copyFolders,clean,jet,rjsOptimizer,components,htmlReplace, assets} from '../index'
...
async function prodCordova(args) {
    ...
    await run(copyFolders, 'temp/assets app/www/assets')
