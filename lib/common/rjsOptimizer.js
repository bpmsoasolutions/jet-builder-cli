...
var rjsOptimizer = function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(args) {
        var requirejsDevCfg, mergedPaths, includes, exclude;
...
var requirejsDev = _fs2.default.readFileSync(_path2.default.resolve('src/app/require.config.js'));
var bowerCfg = JSON.parse(_fs2.default.readFileSync(_path2.default.resolve('.bowerrc')));
