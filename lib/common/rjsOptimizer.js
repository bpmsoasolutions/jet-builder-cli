...
var rjsOptimizer = function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(args) {
        var requirejsDev, bowerCfg, requirejsDevCfg, mergedPaths;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _shelljs2.default.ls('temp/**/*.js').filter(function (e) {
                            return e.indexOf('bower_modules') < 0;
                        }).filter(function (e) {
                            return e.indexOf('require.config.js') < 0;
                        }).forEach(function (f) {
                            _rjs.requireJsConfig.include.push(f.replace("temp/", "").replace(".js", ""));
                        });
