                ...
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        platforms.forEach(function (platform) {
                            ...
                            (0, _index2.default)(_index.copyFolders, jetPath + '/css/' + platform.in + '/images app/merges/' + platform.out + '/images');
                            (0, _index2.default)(_index.copyFolders, jetPath + '/css/' + platform.in + '/fonts app/merges/' + platform.out + '/fonts');
                        });
                        _context.next = 13;
                        break;
                    ...
                    case 7:
                        _context.next = 9;
                        return (0, _index2.default)(_index.copyFolders, jetPath + '/css/alta/fonts ' + destination + '/fonts');
                    ...
                    case 11:
                        _context.next = 13;
                        return (0, _index2.default)(_index.copyFolders, jetPath + '/css/alta/images ' + destination + '/images');

                    case 13:
                        _context.next = 15;
                        return (0, _index2.default)(_index.copyFolders, jetPath + '/css/common ' + destination + '/common');

                    case 15:
                        _context.next = 17;
                        return (0, _index2.default)(_index.copyFolders, jetPath + '/js/libs/oj/resources ' + destination + '/resources');
                    ...
                    case 19:
                        _context.next = 21;
                        return (0, _index2.default)(_index.copyFolders, jetPath + '/js/libs/oj/resources/nls ' + destination + '/ojtranslations/nls');
