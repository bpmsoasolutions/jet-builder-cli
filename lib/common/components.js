            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _shelljs2.default.exec(_path2.default.join(_index.pwd, 'node_modules/.bin/babel') + ' src --ignore=' + _babel.ignores + ' --source-maps=inline --presets=' + _babel.presets + ' --plugins=' + _babel.plugins + ' --out-dir=' + output);
