            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        css = _shelljs2.default.exec(_path2.default.join(_index.pwd, 'node_modules/.bin/node-sass') + ' src/scss/styles.scss', { silent: true });
                    ...
                    case 8:
                        ...
                        if (minize) {
                            _shelljs2.default.ShellString(css).exec(_path2.default.join(_index.pwd, 'node_modules/.bin/uglifycss'), { silent: true }).to(output + '/styles.css');
                        } else {
