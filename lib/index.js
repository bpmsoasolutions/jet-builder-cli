...
if (_fs2.default.existsSync(_path2.default.resolve(pwd, 'node_modules/.bin', 'cordova'))) {
    binPwd = _path2.default.resolve(pwd, 'node_modules/.bin');
} else if (_fs2.default.existsSync(_path2.default.resolve(pwd, '../.bin', 'cordova'))) {
    binPwd = _path2.default.resolve(pwd, '../.bin');
} else {
    throw new Error('Any executable find, try "yarn" or "npm install"');
}

var cordovaPwd = exports.cordovaPwd = _path2.default.resolve(binPwd, 'cordova');
var ripplePwd = exports.ripplePwd = _path2.default.resolve(binPwd, 'ripple');
var ncpPwd = exports.ncpPwd = _path2.default.resolve(binPwd, 'ncp');
var babelPwd = exports.babelPwd = _path2.default.resolve(binPwd, 'babel');
var uglifyPwd = exports.uglifyPwd = _path2.default.resolve(binPwd, 'uglifycss');
var sassPwd = exports.sassPwd = _path2.default.resolve(binPwd, 'node-sass');
