        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 14:
                        _context.next = 16;
                        return (0, _index2.default)(copy, '-rf temp/index.html app/www');

                    case 16:
                        _context.next = 18;
                        return (0, _index2.default)(copy, '-rf temp/scripts.js app/www');

                    case 18:
                        _context.next = 20;
                        return (0, _index2.default)(copy, '-rf temp/styles.css app/www');
